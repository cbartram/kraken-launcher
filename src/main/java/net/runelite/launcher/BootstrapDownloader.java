...
public class BootstrapDownloader {
    ...
    public static BootstrapDependency getBootstrapDependency(HttpClient httpClient, boolean hBootstrap) throws IOException {
        if (bootstrapDependency != null && !hBootstrap) {
            ...
            if (resp.statusCode() != 200) {
                ...
                bootstrapDependency = new Gson().fromJson(resp.body(), BootstrapDependency.class);
                return bootstrapDependency;
            }
        }
    }
